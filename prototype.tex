...
\begin{enumerate}[1.]
  ...
  \begin{enumerate}[(i)]
    ...
    \begin{figure}[H]
      ...
      \includegraphics[width=0.6\linewidth]{q3-1-8.pdf}
    ...
    When $0<\omega_0/\omega\lesssim 2$, $0 < \Delta$ to make $\ket{E_1}$ mix with $\ket{E_2}$ we need only one Floquet Brillouin zone; when $2 \lesssim \omega_0/\omega \lesssim 4$, we need 2 Floquet Brillouin zone; and so on.
